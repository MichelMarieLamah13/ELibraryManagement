                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:LinkButton class="btn btn-success mr-1" ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" title="Active">
                                  <i class="fas fa-check-circle"></i>
                                        </asp:LinkButton>
                                        <asp:LinkButton class="btn btn-warning mr-1" ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" title="Pending">
                                  <i class="far fa-pause-circle"></i>
                                        </asp:LinkButton>
                                        <asp:LinkButton class="btn btn-danger mr-1" ID="LinkButton3" runat="server" OnClick="LinkButton3_Click" title="Deactive">
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eLibraryDBConnectionString %>" SelectCommand="SELECT [member_id], [full_name], [account_status], [contact_no], [email], [state], [city] FROM [member_master_tbl]"></asp:SqlDataSource>
